...
/**
 * Class RecordLabelSongDatatable
 *
 * @package AppBundle\Datatables
 */
class RecordLabelSongDatatable extends AbstractDatatableView
{
    ...
    public function buildDatatable(array $options = array())
    {
        ...
        if(isset($options['recordLabelId'])){
            $this->ajax->set(array(
                'url' => $this->router->generate('song_list_results',array(
                    'artistId' => 0,
    ...
    {
        return 'record_label_song_datatable';
    }
}

...
/**
 * Class ArtistSongStreamTransactionsDatatable
 *
 * @package AppBundle\Datatables
 */
class ArtistSongStreamTransactionsDatatable extends AbstractDatatableView
{
    ...
    public function buildDatatable(array $options = array())
    {
        ...
        if(isset($options['artistId'])){
            $this->ajax->set(array(
                'url' => $this->router->generate('artist_transaction_list_results',array('artistId'=>$options['artistId'])),
                'type' => 'GET',
                'pipeline' => 0
            ));
        }else{
            $this->ajax->set(array(
                'url' => $this->router->generate('artist_transaction_list_results'),
                'type' => 'GET',
                'pipeline' => 0
            ));
        }
        ...
        $this->columnBuilder
            ...
            ->add('artistObject.title', 'column', array('visible' => false,'title'=>"Artist"))
    ...
    {
        return 'artist_song_stream_transactions_datatable';
    }
}

...
/**
 * Class PromoMonitoredDatatable
 *
 * @package AppBundle\Datatables
 */
class PromoMonitoredDatatable extends AbstractDatatableView
{
    ...
    public function buildDatatable(array $options = array())
    {
        ...
        if(isset($options['promoId'])){
            $this->ajax->set(array(
                'url' => $this->router->generate('promo_transaction_list_results',array(
            ...
            $this->ajax->set(array(
                'url' => $this->router->generate('promo_transaction_list_results'),
                'type' => 'GET',
                'pipeline' => 0
            ));
        }
        ...
        $this->columnBuilder
            ...
            ->add('promo.title', 'column', array('visible' => false))
            ->add('promo.slug', 'column', array('visible' => false))
    ...
    {
        return 'promo_stream_transactions_datatable';
    }
}

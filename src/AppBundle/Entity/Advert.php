...
class Advert extends Audio
{
     ...
     * @Gedmo\Versioned
     */
    private $lastPlayOnRadioStation;
    ...
    public function getLastPlayOnRadioStation()
    {
        return $this->lastPlayOnRadioStation;
    }

    public function setLastPlayOnRadioStation($lastPlayOnRadioStation)
    {
        $this->lastPlayOnRadioStation = $lastPlayOnRadioStation;
    }

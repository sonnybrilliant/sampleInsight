...
class Promo extends Audio
{
    ...
    public function getIsRadioPromo()
    {
        return $this->isRadioPromo;
    }

    public function setIsRadioPromo($isRadioPromo)
    {
        $this->isRadioPromo = $isRadioPromo;
    }

...
class RadioStationIncomingQueueRejectHandler
{
    /**
    ...
    /**
     * RadioStationIncomingQueueRejectHandler constructor.
     *
     ...
     * @return bool
     */
    public function reject(RadioStationQueue $radioStationQueue)
    {
        $radioStationQueue->setStatus($this->statusService->rejected());
        $radioStationQueue->setIsRejected(true);
        $radioStationQueue->setRejectedAt(new \DateTime());
        $this->radioStationIncomingQueueService->update($radioStationQueue);

        /**
         * TODO - Fire event to notify user of Rejection
         */
        return true;
    }

...
class AdvertisingOrganizationCreateHandler
{
    /**
    ...
    public function handle(Form $form)
    {
        ...
        try{
            $this->advertisingOrganizationService->create($advertisingOrganization);
            $this->alertService->setSuccess(sprintf("You have successfully added organization: %s ",$advertisingOrganization->getName()));
        }catch (\Exception $e){
            $this->alertService->setError("Oops something went wrong whilst adding organization, please contact admin.");

...
class RadioShowCreateHandler
{
    ...
    public function handle(Form $form)
    {
        ...
        try{
            ...
            $this->radioShowService->create($radioShow);
            $this->alertService->setSuccess(sprintf("You have successfully added radio show : %s ",$radioShow->getTitle()));

        }catch (\Exception $e){
            $this->alertService->setError("Oops something went wrong whilst adding radio show , please contact admin.");

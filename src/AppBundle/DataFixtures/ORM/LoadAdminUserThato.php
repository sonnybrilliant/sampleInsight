...
class LoadAdminUserThato extends AbstractFixture implements OrderedFixtureInterface,ContainerAwareInterface
{
    ...
    public function load(ObjectManager $manager)
    {
        ...
        $user->setLastName("Nhlapo");
        $user->setEmail("thato@ocmafrica.com");
        $user->setPlainPassword('654321');
        $user->setMsisdn('0844825611');
        ...
        $this->addReference('user-admin-thato',$user);
    }
